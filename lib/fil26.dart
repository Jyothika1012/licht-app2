...
import 'package:flutter_application_1/file3.dart';
import 'package:flutter_application_1/file5.dart';
...
List<Details> _list = [
  Details(
      ...
      secomdarycolor: Color.fromARGB(255, 118, 167, 119),
      noOfstar: 1,
      goto: FlipCardGame(Level.Easy)),
  Details(
      name: "MEDIUM",
      primarycolor: Colors.orange,
      secomdarycolor: Color.fromARGB(255, 189, 145, 77),
      noOfstar: 2,
      goto: FlipCardGame(Level.Medium)),
  Details(
      name: "HARD",
      primarycolor: Colors.red,
      secomdarycolor: const Color.fromARGB(255, 164, 101, 96),
      noOfstar: 3,
